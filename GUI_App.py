#we develop the front of this application using tkinter
...
label=Label(top,background='#FFA07A', font=('arial',15,'bold'))
...
heading.configure(background='#FFA07A',foreground='#364156')
heading.pack()
top.mainloop()
